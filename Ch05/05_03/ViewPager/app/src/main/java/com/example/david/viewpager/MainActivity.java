...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set a page transformer on the ViewPager, passing in a true
        // value to reverse the drawing order (in order to have effect go in
        // both directions), as well as an instance of my
